User.create!([
  ...
  {username: "Rabbit", password_digest: "$2a$10$okSGn.ka2s8fbN79jP833uRSyEoRrkL3Oi1/SpF8HHejdJoK2nMXK", session_token: "pd735zKFSSnHBe1okY_n0g", profile_photo_file_name: "data", profile_photo_content_type: "image/jpeg", profile_photo_file_size: 255593, profile_photo_updated_at: "2014-11-17 22:38:37"},
  {username: "Winnie", password_digest: "$2a$10$yj66HjVMYc1ysIdfoy.8eeMHrTJCGRfsm4FQ4GN/AXjoEWFEoAwr.", session_token: "ZTSLE-jKMALBKi7mUMK5LA", profile_photo_file_name: "data", profile_photo_content_type: "image/jpeg", profile_photo_file_size: 199307, profile_photo_updated_at: "2014-11-17 14:47:03"}
])
...
Business.create!([
  ...
  {name: "Sarabeth’s Bakery", zip: "10011", phone_number: "", website_address: "", address: "75 9th Ave", city_id: 2},
  {name: "The Stanton Social", zip: "10002", phone_number: "(212) 555-5555", website_address: "", address: "99 Stanton St", city_id: 2},
  {name: "Jean-Georges", zip: "10023", phone_number: "", website_address: "", address: "1 Central Park W", city_id: 2},
  {name: "Forty Carrots", zip: "10022", phone_number: "", website_address: "", address: "141-199 E 59th St", city_id: 2},
  {name: "Maoz Vegetarian", zip: "10003", phone_number: "", website_address: "", address: "38 Union Sq E", city_id: 2},
  {name: "Cafe Airlie", zip: "07102", phone_number: "", website_address: "", address: "32 Commerce St", city_id: 3},
  {name: "Blue Lotus", zip: "07302", phone_number: "(201) 555-5555", website_address: "", address: "131 Erie St", city_id: 4},
  {name: "Veggie Heaven", zip: "07043", phone_number: "(973) 555-5555", website_address: "", address: "631 Valley Rd", city_id: 5},
  {name: "Sahara Deli", zip: "07105", phone_number: "(973) 555-5555", website_address: "", address: "22 24 Ferry St", city_id: 3},
  {name: "Panorama Cafe", zip: "11432", phone_number: "", website_address: "", address: "84-73 Parsons Blvd", city_id: 6},
  {name: "Ananda Fuara", zip: "94102", phone_number: "", website_address: "", address: "1298 Market St", city_id: 7},
  {name: "Cinco De Mayo", zip: "07201", phone_number: "", website_address: "", address: "1169 Dickinson St", city_id: 8},
  {name: "Pandang", zip: "07079", phone_number: "", website_address: "", address: "8-12 Village Plz", city_id: 9},
  {name: "Empanadas Cafe", zip: "11368", phone_number: "", website_address: "", address: "56-27 Van Doren St", city_id: 6},
  {name: "Wafa’s", zip: "11375", phone_number: "", website_address: "", address: "100-05 Metropolitan Ave", city_id: 6},
  {name: "Mike’s Deli", zip: "10458", phone_number: "", website_address: "", address: "2344 Arthur Ave", city_id: 10}
])

Review.create!([
  {content: "They serve a good breakfast, and have Honey in their name!!!", rating: 4, user_id: 1, business_id: 2},
  {content: "  \tThis is a nice cafe, but they don't have any Hunny. :(", rating: 2, user_id: 1, business_id: 9}
])
